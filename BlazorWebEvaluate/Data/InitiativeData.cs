...
namespace BlazorWebEvaluate.Data
{
    public class InitiativeData
    {
        ...
        public int Scroll(){
            ...
            // L1 3
            if(this.level1 !=null && this.level1.c1 == true && this.level1.c2 == true && this.level1.c3 == true){
                top = 1;
                ...
                if(this.level3 !=null && this.level3.c1 == true && this.level3.c2 == true && this.level3.c3 == true && this.level3.c4 == true && this.level3.c5 == true){
                    ...
                    // L5 3
                    if(this.level5 !=null && this.level5.c1 == true && this.level5.c2 == true && this.level5.c3 == true){
                        top = 5;
                    }else{
                        top = 4;
                    }
